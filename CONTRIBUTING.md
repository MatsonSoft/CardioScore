...
Gracias por tu interés en mejorar la Calculadora de Riesgo Cardiovascular.

## Regla de oro: revisión clínica obligatoria

Cualquier cambio que afecte el **modelo de cálculo** (coeficientes en `MODEL`,
umbrales de riesgo, metas de LDL, fórmula de TFG) debe ser revisado y aprobado
por un miembro del **Postgrado de Cardiología** antes de fusionarse. Esto incluye:
...
Los cambios puramente de interfaz (HTML/CSS, accesibilidad, traducciones, PDF)
no requieren revisión clínica, pero sí pasar la validación de la PR.

## Flujo

1. Haga un fork del repositorio.
2. Cree una rama: `git checkout -b mejora/lo-que-haga`.
3. Haga sus cambios en `calculadora_riesgo_modificada.html`.
4. Verifique que el HTML/JS no tenga errores de sintaxis.
5. Abra un Pull Request describiendo el cambio y, si toca el modelo, nombre al
   revisor clínico.
